                        ...
                        <div className="container position-relative z-2">
                                ...
                                <div className="rotate-90">
                                    <p className="mb-0 text-nowrap">
                                        ...
                                        <Link href="/" className="text-dark fw-medium">
                                            <span className="text-dark fw-bold">©Alithemes</span>
                                        </Link>
                            ...
                            <div className="border-4 pt-120 bg-primary-2 position-relative">
                                    ...
                                    <div className="col-lg-8 mt-lg-0 mt-8">
                                        <div className="row">
                                            ...
                                            <div className="col-lg-3 offset-md-2 col-md-5">
                                                <h6 className="pb-3 text-white border-bottom pb-4 mb-4 border-white border-opacity-25">Our Services</h6>
                                ...
                                <div className="text-center py-4 d-flex align-items-center justify-content-center flex-wrap d-lg-none d-block">
                                    ...
                                    <p className="text-white opacity-50 mb-0">2025, All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
