                ...
                <div className="container">
                    <div className="row pt-lg-10">
                        <div className="col-lg-4">
                            ...
                            <p className="text-anime-style-1">We offer a wide range of digital marketing services that cater to business of all sizes.</p>
                            <ul className="list-unstyled mt-4">
                                <li className="d-flex align-items-center mb-3 gap-3" data-aos="fade-left" data-aos-delay={0}>
                                    ...
                                    <p className="mb-0 text-primary-2 fw-semibold">We offer a wide range of digital marketing</p>
                                </li>
                        ...
                        <div className="col offset-lg-1 mt-lg-0 mt-8 d-none d-lg-block">
                            <div className="position-relative">
                                <img data-aos="fade-up" src="assets/imgs/pages/insurance-consultancy/page-about/img-2.png" alt="AstraX" />
