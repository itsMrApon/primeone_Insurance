                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    <div className="col-lg-5">
                                                        <div className="d-flex flex-column h-100">
                                                            ...
                                                            <h2 className="text-anime-style-2 text-primary-2 my-3">Life Insurance</h2>
                                                            ...
                                                            <div className="mt-lg-auto mt-6">
                                                                <Link href="/portfolio-details" className="btn btn-white hover-up">
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="assets/imgs/pages/insurance-consultancy/page-home/home-section-3/img-1.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    <div className="col-lg-5">
                                                        <div className="d-flex flex-column h-100">
                                                            ...
                                                            <h2 className="text-anime-style-2 text-white my-3">Home Insurance</h2>
                                                            ...
                                                            <div className="mt-lg-auto mt-6">
                                                                <Link href="/portfolio-details" className="btn btn-primary hover-up">
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="assets/imgs/pages/insurance-consultancy/page-home/home-section-3/img-2.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="row g-5 position-relative z-1">
                                                    <div className="col-lg-5">
                                                        <div className="d-flex flex-column h-100">
                                                            ...
                                                            <h2 className="text-anime-style-2 text-white my-3">Vehicles Insurance</h2>
                                                            <p className="text-white">We offer a wide range of digital market services that cater to business of all sizes a forward-think and clever approach. Hands down one of the best shirts I’ve ever owned. Fits great, feels amazing, seems.</p>
                                                            <div className="mt-lg-auto mt-6">
                                                                <Link href="/portfolio-details" className="btn btn-white hover-up">
                                                                    <span className="text-primary-2">read more</span>
                                                    ...
                                                    <div className="col-lg-6 text-lg-end ms-auto d-none d-lg-block">
                                                        <img src="assets/imgs/pages/insurance-consultancy/page-home/home-section-3/img-3.png" alt="AstraX" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
